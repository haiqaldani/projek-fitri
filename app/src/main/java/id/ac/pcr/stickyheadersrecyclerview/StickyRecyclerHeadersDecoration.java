package id.ac.pcr.stickyheadersrecyclerview;
...
import id.ac.pcr.stickyheadersrecyclerview.caching.HeaderProvider;
import id.ac.pcr.stickyheadersrecyclerview.caching.HeaderViewCache;
import id.ac.pcr.stickyheadersrecyclerview.calculation.DimensionCalculator;
import id.ac.pcr.stickyheadersrecyclerview.rendering.HeaderRenderer;
import id.ac.pcr.stickyheadersrecyclerview.util.LinearLayoutOrientationProvider;
import id.ac.pcr.stickyheadersrecyclerview.util.OrientationProvider;

public class StickyRecyclerHeadersDecoration extends RecyclerView.ItemDecoration {
    private final Kalender.DateAdapter mAdapter;
    ...
    private StickyRecyclerHeadersDecoration(StickyRecyclerHeadersAdapter adapter, HeaderRenderer headerRenderer,
        ...
        mAdapter = (Kalender.DateAdapter) adapter;
